...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/OEMP.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
...
?>
 ...
 <div class = "texty">
  ...
  <h3>Department of electronics, microcomputers and PLC systems (OEMP)</h3>
