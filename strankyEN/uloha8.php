...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/uloha8.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
...
echo "<tr>";
	echo "<td><b>Project number</b></td>";
	echo "<td><b>Project name</b></td>";
	echo "<td><b>Duration</b></td>";
	echo "<td><b>Coordinator</b></td>";
...
for($i=0;$i<count($kegy);$i++){   //telo kegy tabulky
	...
	echo "<tr id='" .$kegy[$i][6]. ";" .$kegy[$i][12]. "' onclick='vypisAnot(this.id)' >";
	echo "<td>".$kegy[$i][3]."</td>";
	echo "<td>".$kegy[$i][5]."</td>";
	echo "<td>".$kegy[$i][6]."</td>";
	echo "<td>".$kegy[$i][7]."</td>";
...
for($i=0;$i<count($vegy);$i++){   //telo vegy tabulky
	echo "<tr id='" .$vegy[$i][6]. ";" .$vegy[$i][12]. "' onclick='vypisAnot(this.id)'>";
	echo "<td>".$vegy[$i][3]."</td>";
	echo "<td>".$vegy[$i][5]."</td>";
	echo "<td>".$vegy[$i][6]."</td>";
	echo "<td>".$vegy[$i][7]."</td>";
...
for($i=0;$i<count($apvv);$i++){   //telo apvv tabulky
	echo "<tr id='" .$apvv[$i][6]. ";" .$apvv[$i][12]. "' onclick='vypisAnot(this.id)'>";
	echo "<td>".$apvv[$i][3]."</td>";
	echo "<td>".$apvv[$i][5]."</td>";
	echo "<td>".$apvv[$i][6]."</td>";
	echo "<td>".$apvv[$i][7]."</td>";
...
echo "</table>";
//////////////////////////////////INE
echo "<h3>Other domestic projects</h3>";
echo "<table>";
echo "<tr>";
	echo "<td><b>Project number</b></td>";
	echo "<td><b>Project name</b></td>";
...
for($i=0;$i<count($ine);$i++){   //telo ine tabulky
	echo "<tr id='" .$ine[$i][6]. ";" .$ine[$i][12]. "' onclick='vypisAnot(this.id)'>";
	echo "<td>".$ine[$i][3]."</td>";
	echo "<td>".$ine[$i][5]."</td>";
	echo "<td>".$ine[$i][6]."</td>";
	echo "<td>".$ine[$i][7]."</td>";
...
echo "<h3>International projects</h3>";
echo "<table>";
echo "<tr>";
	echo "<td><b>Project number</b></td>";
	echo "<td><b>Project name</b></td>";
...
for($i=0;$i<count($medzinarodne);$i++){   //telo Medzinárodnej tabulky
	echo "<tr id='" .$medzinarodne[$i][6]. ";" .$medzinarodne[$i][12]. "' onclick='vypisAnot(this.id)'>";
	echo "<td>".$medzinarodne[$i][3]."</td>";
	echo "<td>".$medzinarodne[$i][5]."</td>";
