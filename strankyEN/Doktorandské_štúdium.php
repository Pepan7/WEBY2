...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/Doktorandské_štúdium.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
...
?>
  <br>
  <h1 class = "nad">Doctoral studies</h1>
