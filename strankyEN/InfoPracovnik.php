...
echo '<div class="informacie">';
echo '<p><b>Name and surname:</b> '.$podrobnosti[0][3].' '. $podrobnosti[0][1].' '. $podrobnosti[0][2].' '. $podrobnosti[0][4].'</p>';
echo '<p><b>Staff Role:</b> '.$podrobnosti[0][10].'</p>';
echo '<p><b>Department:</b> '.$podrobnosti[0][9].'</p>';
echo '<p><b>Phone:</b> +421 2 60291' .$podrobnosti[0][8].'</p>';
echo '<p><b>Room:</b> '.$podrobnosti[0][7].'</p>';
...
//var_dump($result);
    ...
    echo "<th><b>" . "Publications " . "</b></th>";
    echo "<th><b>" . "Type of result " . "</b></th>";
    echo "<th><b>" . "Year " . "</b></th>";
    echo '</thead>';
