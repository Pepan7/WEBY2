...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/uloha11.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
   ...
   $conn=connect();
	...
	//$combin[$keys[1]] = "not so much bling";
		...
		foreach($images as $image) {
			...
			echo "<div class='column2'>";
			$cs++;
			echo "<img src=".$image." alt='' height='130' onclick='openModal();currentSlide(".$cs.")' class='hover-shadow'>";
		...
		foreach($images as $image) {
			...
			//echo		"<button class='gombik' type='button' onclick='showSlidesAuto()'>Play!</button>";
			//echo		"<div  class='popis0'></div>";
			echo "</div>";
		}
		echo	"</div>";
