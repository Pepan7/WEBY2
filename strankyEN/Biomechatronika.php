...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/Biomechatronika.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
...
?>
  <br>
  <h1 class = "nad">Biomechatronics</h1>
