...
$text .= "<ul class='nav navbar-nav navbar-right'>
      <li><a href='../strankySK/Elektrická_motokára.php'><img src='subory/Flag_of_Slovakia.svg.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
...
?>
  <br>
  <h1 class = "nad">Electric car</h1>
 
 <div class = "texty">
  
    <img src="subory/motokara.jpg" alt="Motokara" width="90%" height="2000">
