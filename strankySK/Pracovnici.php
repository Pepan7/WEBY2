...
$text .= "<ul class='nav navbar-nav navbar-right'>
      ...
      <li><a href='../strankyEN/Pracovnici.php'><img src='subory/gb.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
    </ul>
  </div>
  </div>
  </div>
...
//print_r($pracovnici);
        ...
        echo '<table class="display nowrap dataTable dtr-inline" id="myTable"><thead>';
                ...
                echo "<th>"."Titul"."</th>";
                echo "<th>"."Miestnost "."</th>";
                echo "<th>"."Klapka "."</th>";
                echo "<th>"."Oddelenie "."</th>";
                echo "<th>"."Zaradenie "."</th>";
                echo "<th>"."Funkcia "."</th>";
                echo "<th>"."Info "."</th>";
...
<script>
    ...
    $(".info").click(function(){
        ...
        $.ajax({
            type: 'GET',
            url: 'http://147.175.98.192/WB2_Semestralne_zadanie/strankySK/InfoPracovnik.php/id/' +id ,
