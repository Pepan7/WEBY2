...
$text .= "<ul class='nav navbar-nav navbar-right'>
      ...
      <li><a href='../strankyEN/Doktorandské_štúdium.php'><img src='subory/gb.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
    </ul>
  </div>
  </div>
  </div>
...
?>
  <br>
  <h1 class = "nad">Doktorandské štúdium</h1>
