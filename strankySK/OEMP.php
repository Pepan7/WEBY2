...
$text .= "<ul class='nav navbar-nav navbar-right'>
      ...
      <li><a href='../strankyEN/OEMP.php'><img src='subory/gb.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
    </ul>
  </div>
  </div>
  </div>
...
?>
 ...
 <div class = "texty">
  ...
  <h3>Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</h3>
