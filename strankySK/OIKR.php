...
$text .= "<ul class='nav navbar-nav navbar-right'>
      ...
      <li><a href='../strankyEN/OIKR.php'><img src='subory/gb.png' alt='Mountain View' style='width:40px;height:20px;'></a></li>
    </ul>
  </div>
  </div>
  </div>
...
?>
 ...
 <div class = "texty">
  ...
  <h3>Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</h3>
       <b>Vedúci:</b> 	doc. Ing. Danica Rosinová, PhD.<br>
    <b>Zástupca:</b> 	doc. Ing. Katarína Žáková, PhD.<br>

<p class="zviraznit">Informácie budú dodané neskôr.</p>
 </div>
 <?php
$text="";
